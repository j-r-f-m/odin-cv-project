    ...
    <div id="output--container">
      <div className="out--info">
        <div className="output--name">
          {props.state.persInfo.firstName.length > 0
            ? props.state.persInfo.firstName
            : "First Name"}
        </div>
        <div className="output--name">
          {props.state.persInfo.lastName.length > 0
            ? props.state.persInfo.lastName
            : "Last Name"}
        </div>
      </div>
      <div className="output--title">
        {props.state.persInfo.title.length > 0
          ? props.state.persInfo.title
          : "Title"}
      </div>
